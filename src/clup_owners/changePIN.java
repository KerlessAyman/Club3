...
public class changePIN extends javax.swing.JFrame {
    ...
    public changePIN() {
        ...
        try {
            ...
            con = c1.connect();
            System.out.println("connected <<changePIN>>");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 430, 200, -1));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("User Name");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 280, 230, 40));
        getContentPane().add(edt_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 340, 350, 60));
        getContentPane().add(edt_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 500, 360, 60));
        ...
        jLabel5.setText("SignIn a basic admin account");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 690, 110, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (r.next()) {
                if (r.getString("user_name").equalsIgnoreCase(edt_user.getText())) {
                    if (r.getString("pass").equals(edt_pass.getText())) {
