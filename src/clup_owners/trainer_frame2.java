 ...
 * @author HP
 */
public class trainer_frame2 extends javax.swing.JFrame {
      public Connection con;
    /**
     * Creates new form trainer_frame2
     */
    public trainer_frame2() {
        initComponents();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);
         try {
            ...
            con = c1.connect();
            System.out.println("connected <<trainer_frame2>>");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 650, -1, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        trainer a1=new trainer(btn_userName.getText(), btn_password.getText());

        int i= a1.check_traineracc(btn_userName.getText(), btn_password.getText());
        if(i==1){
        ...
        JOptionPane.showMessageDialog(this, "not Successful"+"\n password is wrong");
         ...
         int m=a1.check_user(btn_userName.getText(), btn_password.getText());
          if(m==1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trainer_frame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new trainer_frame2().setVisible(true);
            }
        });
    }
